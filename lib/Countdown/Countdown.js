...
class Countdown {
  ...
  *        id: ID of the <div> you want the timer in
  ...
  */
  constructor(config={}) { //path, id, start=10, stop=0, speedMS=1000, warnAt=null, critAt=null) {
    ...
    this.e = document.getElementById(this.id); //Container Element (need for sizing)
    this.dom = {};
    this.svg = {};
    this.initSVGs();
    this.initDOM();
  ...
  */
  initDOM() {
    ...
    this.e.classList.add('_counter_div'); //Wrapper class for Styling
    // Create, Cache, & Set Class/Src for necessary IMGs/DIVs in DOM
	this.dom.digitOnes = document.createElement('div');
	this.dom.digitOnes.classList.add('_counter_digit', '_counter_digit_left');
