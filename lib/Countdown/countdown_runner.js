...
*/
function initCountdown(id, start, stop, speedMS, warnAt, critAt, test_colors=false) {
  let config = { 'id':id, 'start':start, 'stop':stop, 'speedMS':speedMS, 'warnAt':warnAt, 'critAt':critAt };
